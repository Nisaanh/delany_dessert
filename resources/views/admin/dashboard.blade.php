                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex flex-column">
                                                <small class="text-muted fw-semibold">{{ $order->formatted_created_at }}</small>
...
<style>
    ...
    .stat-products .stat-icon {
        background: linear-gradient(135deg, #4e73df, #7a8de6);
    }

    .stat-orders .stat-icon {
        background: linear-gradient(135deg, #1cc88a, #3cd49c);
    }

    .stat-revenue .stat-icon {
        background: linear-gradient(135deg, #36b9cc, #5cccdd);
    }

    .stat-users .stat-icon {
        background: linear-gradient(135deg, #f6c23e, #f8d568);
    }
    ...
    .action-danger .action-icon {
        background: linear-gradient(135deg, #e74a3b, #eb6659);
    }
